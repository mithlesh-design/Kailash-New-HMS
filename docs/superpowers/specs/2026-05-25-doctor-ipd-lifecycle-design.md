...
**Date:** 2026-05-25
**Context:** AI-first HMS (Kailash HMS). Builds on the existing doctor portal. Goal: a complete inpatient (IPD) journey handled in BOTH the doctor and patient portals, plus targeted upgrades (AI copilot, records table, messaging inbox, activity date range).
