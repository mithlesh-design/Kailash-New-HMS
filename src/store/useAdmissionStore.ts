...
// The `beds` array is THIS branch (Kailash — MG Road). Other branches expose
...
export const CURRENT_BRANCH = { id: 'mg-road', name: 'Kailash Healthcare — MG Road', location: 'MG Road', distanceKm: 0, phone: '+91 80 1234 0000' }

export const OTHER_BRANCHES: Branch[] = [
  {
    id: 'whitefield', name: 'Kailash Healthcare — Whitefield', location: 'Whitefield', distanceKm: 8.2, phone: '+91 80 1234 1111',
    wards: [
  ...
  {
    id: 'indiranagar', name: 'Kailash Healthcare — Indiranagar', location: 'Indiranagar', distanceKm: 5.1, phone: '+91 80 1234 2222',
    wards: [
