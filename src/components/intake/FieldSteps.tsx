          ...
          {(['Male', 'Female', 'Other'] as Gender[]).map(g => {
            ...
            return (
              <button
                ...
                aria-pressed={sel}
                className={cn(
                  "h-12 rounded-[14px] text-[15px] font-semibold border transition-all active:scale-[0.97] focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500",
                  sel ? "bg-blue-600 border-blue-600 text-white shadow-[0_4px_12px_rgba(37,99,235,0.25)]" : "bg-white border-slate-200 text-slate-700"
                )}
              >
                {g}
              </button>
  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className={cn(
          "w-full flex items-center gap-3 px-4 py-4 rounded-[16px] transition-all active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500",
          form.hasReports ? "bg-blue-600 text-white shadow-[0_6px_16px_rgba(37,99,235,0.25)]" : "bg-white text-slate-900 shadow-[0_1px_3px_rgba(0,0,0,0.04)]"
        )}
      >
  ...
  return (
    <div className="space-y-3">
      <div className="bg-white rounded-[16px] overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
        <button onClick={() => update({ dishaConsent: !form.dishaConsent })} aria-pressed={form.dishaConsent} className="w-full flex items-center justify-between px-4 py-3.5 focus:outline-none focus-visible:bg-blue-50/40">
          <span className="flex items-center gap-3">
            <span className={cn("h-9 w-9 rounded-full flex items-center justify-center", form.dishaConsent ? "bg-blue-100" : "bg-slate-100")}>
              <QrCode className={cn("h-5 w-5", form.dishaConsent ? "text-blue-600" : "text-slate-500")} aria-hidden="true" />
            </span>
          ...
          <span className={cn("h-6 w-11 rounded-full transition-colors flex-shrink-0", form.dishaConsent ? "bg-blue-500" : "bg-slate-200")}>
