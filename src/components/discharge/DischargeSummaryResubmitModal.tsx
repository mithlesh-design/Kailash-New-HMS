        ...
        <div className="px-6 py-4 overflow-y-auto space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={10}
              className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm text-slate-800 leading-relaxed whitespace-pre-wrap focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm text-slate-800 leading-relaxed focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        </div>
