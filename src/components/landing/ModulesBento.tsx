...
const GROUPS = [
  { label: "Clinical", color: "#1E3A8A", items: [
  ...
  { label: "Operations", color: "#0E9F6E", items: [
  ...
  { label: "Finance", color: "#2563EB", items: [
    { icon: CreditCard, name: "Billing" }, { icon: FileText, name: "Insurance / TPA" },
  ] },
  { label: "Management & Support", color: "#1E3A8A", items: [
    ...
    <section id="platform" className="scroll-mt-20 py-20 lg:py-28 bg-white border-y border-[#EAECF2]">
      <div className="max-w-7xl mx-auto px-5 lg:px-10">
        <Reveal className="max-w-2xl">
          <p className="text-[12px] font-bold uppercase tracking-[0.14em] text-[#1E3A8A]">One platform, every department</p>
