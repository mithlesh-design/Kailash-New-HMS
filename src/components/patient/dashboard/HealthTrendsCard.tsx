...
const STATS = [
  ...
  { icon: HeartPulse, tint: 'text-blue-600 bg-blue-50', label: 'Avg BP', value: '130/85', delta: '↓ improving' },
        ...
        <div style={{ height: 110 }}>
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={BP} margin={{ top: 5, right: 4, left: 4, bottom: 0 }}>
              ...
              <Tooltip />
              <Area type="monotone" dataKey="v" name="Systolic" stroke="#2563EB" strokeWidth={2.5} fill="url(#bpFill)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
