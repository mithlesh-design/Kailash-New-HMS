...
export function DoctorOrdersCard() {
  ...
  if (paid) {
    ...
    return (
      <div className="rounded-3xl bg-white shadow-[0_1px_4px_rgba(15,23,42,0.06),0_8px_28px_rgba(15,23,42,0.05)] p-4 flex items-center gap-3">
        ...
        <Link href="/patient/orders" className="text-[13px] font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1 flex-shrink-0">View <ArrowRight className="h-3.5 w-3.5" /></Link>
      </div>
    )
  }
  ...
  return (
    <div className="rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-600 text-white p-5 shadow-[0_10px_30px_rgba(37,99,235,0.3)] relative overflow-hidden">
      ...
      <Link href="/patient/orders" className="w-full bg-white text-blue-700 font-bold text-[14px] rounded-xl py-2.5 flex items-center justify-center gap-2 active:scale-[0.98] transition">
