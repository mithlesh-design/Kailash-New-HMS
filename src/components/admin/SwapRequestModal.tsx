          ...
          <motion.div
            ...
            <div onClick={(e) => e.stopPropagation()}
              ...
              <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                    <ArrowLeftRight className="h-5 w-5 text-blue-600" />Swap Request
                  </h2>
                                ...
                                <button key={`${s.date}-${s.shift}`} type="button"
                                  ...
                                  className={cn('text-[11px] font-bold px-2 py-1 rounded-lg border cursor-pointer transition text-left',
                                    requesterDate === s.date && requesterShift === s.shift
                                      ? 'border-blue-400 bg-blue-50' : 'border-slate-200 hover:bg-slate-50')}>
                  ...
                  <>
                    <div className="rounded-xl border border-blue-200 bg-blue-50/40 p-4 space-y-3">
                      <div className="flex items-center gap-2">
                        <span className="h-9 w-9 rounded-xl bg-blue-100 text-blue-700 flex items-center justify-center text-sm font-bold flex-shrink-0">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="h-9 w-9 rounded-xl bg-indigo-100 text-indigo-700 flex items-center justify-center text-sm font-bold flex-shrink-0">
              ...
              <div className="px-5 py-3 border-t border-slate-100 flex items-center gap-2 justify-end bg-slate-50/30">
                {step === 'pick' && (
                  <>
                    ...
                    <button onClick={handleNext} disabled={!isValid}
                      className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-700 text-white cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed">
                ...
                {step === 'sent' && (
                  <button onClick={handleClose}
                    className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold bg-indigo-600 hover:bg-indigo-700 text-white cursor-pointer">
                    Done
                  </button>
                )}
              </div>
