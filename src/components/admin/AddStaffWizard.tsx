              ...
              <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                    <User className="h-5 w-5 text-indigo-600" />Add Staff Member
                  </h2>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Field label="Email" icon={Mail} required>
                        <input type="email" value={identity.email} onChange={(e) => setIdentity({ ...identity, email: e.target.value })}
                          placeholder="anjali.mehra@kailash.in" className={INPUT} />
                      </Field>
                ...
                {step === 3 && (
                  <>
                    <div className="rounded-xl border border-indigo-200 bg-indigo-50/30 p-4">
                      <p className="text-[10px] font-bold uppercase tracking-wide text-indigo-700 mb-2">Login & access</p>
                      <Field label="Login ID" icon={Shield} required>
                        <div className="flex items-center gap-2">
                          ...
                          <button type="button"
                            ...
                            className="text-[11px] font-bold text-indigo-700 hover:underline cursor-pointer whitespace-nowrap">Suggest</button>
                        </div>
                      </Field>
                ...
                <div className="flex gap-2">
                  ...
                  {step < 3 ? (
                    <button onClick={handleNext} disabled={step === 1 && !isIdentityValid}
                      className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold bg-indigo-600 hover:bg-indigo-700 text-white cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed">
