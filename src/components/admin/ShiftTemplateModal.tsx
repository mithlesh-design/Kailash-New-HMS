              ...
              <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                    <Sparkles className="h-5 w-5 text-indigo-600" />Apply Shift Pattern
                  </h2>
              ...
              <div className="flex-1 overflow-y-auto p-5 space-y-4">
                    ...
                    {shiftTemplates.map(t => (
                      <button key={t.id} onClick={() => setTemplateId(t.id)}
                        ...
                        className={cn('rounded-xl border p-3 text-left cursor-pointer transition',
                          templateId === t.id ? 'border-indigo-400 bg-indigo-50/50 ring-2 ring-indigo-200' : 'border-slate-200 hover:bg-slate-50')}>
                ...
                <section>
                  <button onClick={() => setPreviewOpen(v => !v)}
                    className="flex items-center gap-1.5 text-[11px] font-bold text-indigo-700 hover:underline cursor-pointer">
