  ...
  return (
    <div className="space-y-3">
      <button
        ...
        disabled={loading}
        aria-busy={loading}
        className="flex items-center gap-2 px-3.5 py-2 bg-blue-600 text-white text-[13px] font-semibold rounded-xl hover:bg-blue-700 transition-colors disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2"
      >
