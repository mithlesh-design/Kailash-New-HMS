              ...
              >
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  {log.status === 'collected' && (
                    <button onClick={() => treat(log.id, log.ward + ' ' + log.category)} className="text-[11px] font-semibold px-2 py-1 rounded-md bg-blue-100 text-blue-700 hover:bg-blue-200 cursor-pointer">
