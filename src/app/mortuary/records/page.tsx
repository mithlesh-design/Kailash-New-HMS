...
export default function MortuaryRecords() {
  ...
  function printCert(certNumber?: string) {
    ...
    w.document.write(`<html><body style="font-family:serif;padding:40px"><h1>KAILASH HOSPITAL</h1><h2>Death Certificate</h2><p>Cert #: <b>${certNumber}</b></p><p>This is a system-generated demo certificate.</p></body></html>`)
            ...
            <div className="flex items-center gap-1.5 flex-wrap pt-3 border-t border-slate-100">
              {!r.deathCertificateNumber && (
                <button onClick={() => issueCert(r.id, r.patientName)}
                  className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[11.5px] font-semibold bg-blue-600 hover:bg-blue-700 text-white cursor-pointer">
