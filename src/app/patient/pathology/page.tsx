          ...
          {released.map(({ order, test }) => {
            ...
            return (
              <div key={test.id} className={cn(
                ...
                <div className={cn("rounded-2xl p-3 flex items-start gap-2.5", hasCritical ? "bg-red-50 border border-red-100" : "bg-violet-50 border border-violet-100")}>
                  ...
                  <div className="min-w-0">
                    ...
                    <p className={cn("text-[13px] mt-0.5", hasCritical ? "text-red-800" : "text-violet-800")}>{summary}</p>
                  </div>
                </div>
              </div>
            )
              ...
              <div key={t.name} className="flex items-center justify-between p-3 rounded-2xl bg-slate-50">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isBooked ? "bg-green-50 text-green-700 cursor-default" : "bg-blue-600 text-white",
                  )}
                >
