...
function TestIcon({ item }: { item: OrderItem }) {
  ...
  const tint = item.dept === 'Radiology' ? 'bg-indigo-50 text-indigo-600' : 'bg-rose-50 text-rose-600'
          ...
          <div className="min-w-0 flex-1">
            ...
            {!paid && isSkipped && (
              <div className="mt-3 flex items-center justify-between gap-3">
                ...
                <button onClick={() => accept(item.id)} className="text-[12.5px] font-semibold text-blue-600 inline-flex items-center gap-1 hover:text-blue-700">
