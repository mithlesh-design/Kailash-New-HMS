  ...
  return (
    <div className="max-w-5xl mx-auto pb-10 space-y-5">
      ...
      <div className="rounded-3xl bg-white shadow-[0_1px_4px_rgba(15,23,42,0.06)] p-5">
        <div className="flex items-center gap-2 mb-4"><Activity className="h-4.5 w-4.5 text-blue-500" /><h3 className="text-[15px] font-bold text-slate-900">Blood pressure trend</h3></div>
