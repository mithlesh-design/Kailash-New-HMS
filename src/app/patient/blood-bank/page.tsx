    ...
    <div className="max-w-4xl mx-auto pb-10 space-y-5">
        ...
        <div className="rounded-3xl bg-white shadow-[0_1px_4px_rgba(15,23,42,0.06),0_8px_28px_rgba(15,23,42,0.05)] p-5">
          <div className="flex items-center justify-between mb-1 flex-wrap gap-1">
            ...
            <span className={cn(
              ...
              : featured.status === 'compatible' ? 'bg-blue-50 text-blue-700'
      ...
      <div className="rounded-3xl bg-white shadow-[0_1px_4px_rgba(15,23,42,0.06),0_8px_28px_rgba(15,23,42,0.05)] p-5">
        ...
        <button
          ...
          disabled={registered}
          className={cn("w-full font-bold text-[15px] rounded-xl py-3 flex items-center justify-center gap-2 transition-transform", registered ? "bg-green-100 text-green-700" : "bg-blue-600 text-white active:scale-[0.97]")}
        >
