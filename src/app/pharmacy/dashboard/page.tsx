...
export default function PharmacyOverview() {
  ...
  const KPIS = [
    ...
    { label: "On counters", value: m.onCounters, icon: Clock, fg: "text-blue-600", bg: "bg-blue-50" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 space-y-3">
            ...
            <Link href="/pharmacy/inventory" className="flex items-center justify-between hover:bg-slate-50 -mx-1 px-1 py-1.5 rounded-lg">
              <span className="text-sm text-slate-600 flex items-center gap-2"><Package className="h-4 w-4 text-blue-500" /> Stock lines</span>
