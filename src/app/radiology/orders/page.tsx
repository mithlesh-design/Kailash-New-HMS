  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        <span className="h-9 w-9 rounded-xl flex items-center justify-center bg-[#1E3A8A]/[0.08] text-[#1E3A8A]"><ClipboardCheck className="h-5 w-5" /></span>
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="rounded-2xl border border-[#EAECF2] bg-white shadow-[var(--shadow-card)] p-5">
          ...
          <button onClick={submit} className="mt-4 w-full h-10 rounded-xl bg-[#1E3A8A] text-white font-semibold text-sm hover:bg-[#172E6E] transition-colors cursor-pointer inline-flex items-center justify-center gap-2">
        ...
        <div className="space-y-3">
          ...
          <div className={cn("rounded-2xl border p-4", V.chip.replace("text-", "border-").split(" ").find(c => c.startsWith("border-")) ?? "border-[#EAECF2]", "bg-white")}>
            <div className="flex items-center gap-2 mb-1">
              <V.icon className="h-4 w-4 text-[#1E3A8A]" />
          ...
          {suggestedPriority !== form.priority && (
            <div className="rounded-2xl border border-[#2563EB]/15 bg-[#F5F8FF] p-4 flex items-center gap-3">
              ...
              <button onClick={() => set("priority", suggestedPriority)} className="text-[12px] font-semibold text-[#1E3A8A] hover:underline cursor-pointer flex-shrink-0">Apply</button>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-[#EAECF2] bg-white shadow-[var(--shadow-card)]">
        <div className="px-5 py-4 border-b border-[#EAECF2] flex items-center gap-2">
          ...
          <Link href="/radiology/schedule" className="ml-auto text-[12px] font-semibold text-[#2563EB] hover:underline">Open scheduling →</Link>
        </div>
          ...
          <div className="divide-y divide-[#F2F4F8]">
            {ordered.map(s => (
              <Link key={s.id} href="/radiology/schedule" className="flex items-center gap-3 px-5 py-3 hover:bg-slate-50 group">
                ...
                <ArrowRight className="h-4 w-4 text-slate-300 group-hover:text-[#1E3A8A] flex-shrink-0" />
              </Link>
            ))}
          </div>
        )}
...
const inputCls = "w-full h-9 px-3 rounded-lg text-[13px] bg-[#F8FAFC] border border-[#EAECF2] focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/15 transition-all"
