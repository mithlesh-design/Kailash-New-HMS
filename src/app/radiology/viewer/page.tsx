        ...
        <div className="space-y-2">
          ...
          {list.map((s) => (
            <button key={s.id} onClick={() => setSelectedId(s.id)}
              className={cn("w-full text-left bg-white rounded-xl border p-3 transition-all", selectedId === s.id ? "border-[#1E3A8A] ring-1 ring-[#1E3A8A]" : "border-[#EAECF2] hover:border-[#D0D5DD]")}>
