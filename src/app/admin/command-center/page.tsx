...
export default function CommandCenter() {
  ...
  const tiles = [
    ...
    { label: 'ER active', value: er.active, sub: `${er.highAcuity} high-acuity · ${er.awaitingTriage} awaiting triage`, icon: Ambulance, tint: er.highAcuity > 0 ? '#DC2626' : '#2563EB' },
    { label: 'OT in use', value: `${ot.utilizationPct}%`, sub: `${ot.inProgress} running · ${ot.scheduled} scheduled`, icon: Scissors, tint: '#1E3A8A' },
    { label: 'IPD census', value: ipd.census, sub: `${ipd.critical} critical · ${ipd.dischargePending} for discharge`, icon: Stethoscope, tint: '#2563EB' },
    ...
    { label: 'Staff on roll', value: staffM.active, sub: `${staffM.onLeave} on leave · ${staffM.total} total`, icon: Users, tint: '#2563EB' },
  ]
