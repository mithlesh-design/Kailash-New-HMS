  ...
  return (
    <div className="space-y-5 p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <KPI label="Open invoices" value={kpis.openInvoices} tint="bg-blue-50 border-blue-200 text-blue-700" />
                          ...
                          <div className="flex gap-1">
                            {i.status === 'open' && (
                              <button onClick={() => handleApprove(i.id)}
                                className="text-[10px] font-bold px-2 py-1 rounded bg-blue-50 hover:bg-blue-100 text-blue-700 cursor-pointer">
                                Approve
                              </button>
                            )}
