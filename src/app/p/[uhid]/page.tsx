...
const PUBLIC_REWRITE: Array<[RegExp, string]> = [
  [/^Registered/, "You're registered at Kailash"],
      ...
      <div className="max-w-md mx-auto p-3 space-y-3">
        ...
        {inpatient && (
          <div className="rounded-2xl bg-white border border-slate-200 p-4 shadow-sm space-y-2">
            ...
            <div className="flex items-center gap-2 text-[12px]">
              <Bed className="h-3.5 w-3.5 text-blue-600 flex-shrink-0" />
        ...
        <p className="text-center text-[10px] text-slate-400 py-2">
          Kailash Healthcare · This is a live tracking page · Updates every 10 seconds
        </p>
      </div>
    </div>
  )
