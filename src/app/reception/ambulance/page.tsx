...
const VEHICLE_STATUS: Record<string, { label: string; tint: string; dot: string }> = {
  ...
  on_trip:        { label: 'On trip',     tint: 'bg-blue-50 text-blue-700',    dot: 'bg-blue-500' },
...
export default function ReceptionAmbulance() {
  ...
  const tiles = [
    ...
    { label: 'On trip', value: onTrip, icon: Activity, tint: 'bg-blue-50 text-blue-600' },
    { label: 'Active trips', value: activeTrips.length, icon: Navigation, tint: 'bg-indigo-50 text-indigo-600' },
