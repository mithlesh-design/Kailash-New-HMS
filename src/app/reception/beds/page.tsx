...
const STATUS_STYLE: Record<string, { tint: string; dot: string }> = {
  ...
  Reserved:    { tint: 'bg-blue-50 text-blue-700 border-blue-100',dot: 'bg-blue-500' },
...
const ETA_TONE: Record<string, string> = {
  ...
  red: 'bg-red-100 text-red-700', violet: 'bg-blue-100 text-blue-700', slate: 'bg-slate-100 text-slate-500',
}
