        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className={cn(CARD, "p-5")}>
            ...
            <div className="space-y-2">
              ...
              {pendingAdmissions.map(r => (
                <AttnRow key={r.id} href="/reception/beds" tint="bg-indigo-50 text-indigo-600" icon={BedDouble}
          ...
          <div className={cn(CARD, "p-5")}>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/reception/opd" className="text-[12.5px] font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1">Open board <ArrowRight className="h-3.5 w-3.5" /></Link>
            </div>
        ...
        <div className="space-y-5">
          ...
          <div className={cn(CARD, "p-5")}>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/reception/appointments" className="text-[12.5px] font-semibold text-blue-600 flex items-center gap-1">All <ChevronRight className="h-3.5 w-3.5" /></Link>
            </div>
            {todayAppts.length === 0 ? (
                ...
                {todayAppts.map(a => {
                  ...
                  return (
                    <div key={a.id} className="flex items-center gap-3 rounded-xl bg-slate-50 px-3 py-2.5">
                      <span className="h-9 w-9 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center flex-shrink-0"><Clock className="h-4.5 w-4.5" /></span>
...
function AttnRow({ href, tint, icon: Icon, title, sub, cta }: {
  ...
  return (
    <Link href={href} className="flex items-center gap-3 rounded-xl bg-slate-50 hover:bg-slate-100 transition px-3 py-2.5">
      ...
      <span className="text-[12px] font-semibold text-blue-600 flex items-center gap-0.5 flex-shrink-0">{cta} <ArrowRight className="h-3.5 w-3.5" /></span>
    </Link>
  )
}
