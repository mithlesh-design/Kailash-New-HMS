...
export default function ReceptionReports() {
  ...
  const tiles = [
    { label: 'Registrations today', value: todayPatients.length, icon: Users, tint: 'bg-blue-50 text-blue-600' },
    { label: 'Appointments today', value: apptsToday, icon: UserPlus, tint: 'bg-indigo-50 text-indigo-600' },
