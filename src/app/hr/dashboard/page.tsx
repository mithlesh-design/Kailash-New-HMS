...
export default function HrDashboard() {
  ...
  const kpis = [
    { label: 'Employees', value: activeStaff.length, sub: `${staff.length} on record`, icon: Users, fg: 'text-blue-700', chip: 'bg-blue-100 text-blue-600', href: '/hr/employees' },
    ...
    { label: 'Open positions', value: openPositions, sub: `${inPipeline} in pipeline`, icon: Workflow, fg: 'text-indigo-700', chip: 'bg-indigo-100 text-indigo-600', href: '/hr/recruitment' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm">
          <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            ...
            <Link href="/hr/leave" className="text-xs font-semibold text-blue-600 hover:text-blue-800">Open</Link>
          </div>
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm">
          <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            <h2 className="text-sm font-bold text-slate-800 flex items-center gap-2"><Workflow className="h-4 w-4 text-indigo-600" /> Recruitment pipeline</h2>
            <Link href="/hr/recruitment" className="text-xs font-semibold text-blue-600 hover:text-blue-800">Open</Link>
          </div>
