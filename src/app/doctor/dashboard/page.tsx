...
export default function DoctorDashboard() {
  ...
  const handleSendLabOrders = () => {
    ...
    // Batch all unsent tests into a single LabOrder (specimens auto-dedup).
    const codes = unsent
    ...
    // Fall back to the shim for tests with no catalog mapping (keeps prior behaviour).
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:h-[calc(100vh-100px)] lg:overflow-hidden gap-4">
      ...
      {offShiftBanner && (
        <div className="absolute top-0 left-0 right-0 z-30 mx-4 mt-2 rounded-xl bg-blue-50 border border-blue-200 px-4 py-2.5 flex items-start gap-2.5 shadow-sm">
          <AlertCircle className="h-4 w-4 text-blue-600 flex-shrink-0 mt-0.5" />
          <p className="text-[12.5px] text-blue-900 leading-relaxed flex-1 min-w-0">
      ...
      {!currentPatient ? (
        ...
        <div className="flex-1 flex flex-col xl:flex-row gap-4 lg:overflow-hidden min-w-0">
                    ...
                    <div className="p-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className={cn("flex items-center justify-between rounded-xl px-3.5 py-2.5", wardFree > 0 ? "bg-green-50" : "bg-amber-50")}>
                          ...
                          <Link href="/doctor/beds" className="text-[12px] font-bold text-blue-600 hover:text-blue-700 flex items-center gap-1 flex-shrink-0">
          ...
          {/* ── Right Sidebar: AI + Rx ──────────────────── */}
          <div className="w-full xl:w-72 flex-shrink-0 flex flex-col gap-4 lg:overflow-hidden">
