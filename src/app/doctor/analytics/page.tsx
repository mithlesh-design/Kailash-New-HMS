  ...
  return (
    <div className="max-w-4xl mx-auto pb-8">
      ...
      <div className={cn(CARD, "p-5 mt-4")}>
        <div className="flex items-center gap-2 mb-3"><TrendingUp className="h-4.5 w-4.5 text-blue-500" /><h3 className="text-[15px] font-bold text-slate-900">Performance trend · {periodLabel}</h3></div>
        <ClientOnly fallback={<div className="h-[260px] flex items-center justify-center"><div className="h-7 w-7 rounded-full border-4 border-blue-200 border-t-blue-600 animate-spin" /></div>}>
