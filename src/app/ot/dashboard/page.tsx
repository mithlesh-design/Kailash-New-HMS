  ...
  return (
    <div className="mt-4 pt-4 border-t border-slate-100 space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h4 className="text-xs font-bold uppercase tracking-wider text-indigo-700">IPD Brief from Ward</h4>
      </div>
            ...
            <div>
              ...
              <div className="space-y-1">
                {brief.ivDrips.map((d, i) => (
                  <p key={i} className="text-xs text-blue-700 font-medium">• {d}</p>
                ))}
              </div>
            </div>
          )}
      ...
      {brief.lastNursingNote && (
        <div className="p-3 rounded-xl bg-indigo-50 border border-indigo-100">
          <p className="text-[10px] font-bold text-indigo-600 mb-1">Last Nursing Note</p>
          <p className="text-xs text-indigo-900 font-medium italic">"{brief.lastNursingNote}"</p>
        </div>
      )}
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      {proc.ipdBrief && (
                        <button
                          ...
                          style={{
                            background: expandedBriefId === proc.id ? '#EEF2FF' : '#F8FAFC',
                            borderColor: expandedBriefId === proc.id ? '#A5B4FC' : '#E2E8F0',
                            color: expandedBriefId === proc.id ? '#4F46E5' : '#64748B',
                          }}
                        >
