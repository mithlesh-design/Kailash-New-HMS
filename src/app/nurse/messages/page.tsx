...
export default function NurseMessages() {
  ...
  return (
    <div className="pb-2 h-full flex flex-col min-h-0">
      ...
      <ClientOnly fallback={<div className="flex-1 flex items-center justify-center"><div className="h-7 w-7 rounded-full border-4 border-blue-200 border-t-blue-600 animate-spin" role="status" aria-label="Loading" /></div>}>
