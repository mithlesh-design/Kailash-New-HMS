  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        {/* Intake / Output */}
        <Card className="p-5">
          <div className="flex items-center gap-2 mb-3"><Droplets className="h-4 w-4 text-blue-600" /><h2 className="text-sm font-bold text-slate-900">Fluid balance</h2></div>
          <div className="grid grid-cols-3 gap-2 mb-2">
            <div className="bg-slate-50 rounded-lg p-2 text-center"><p className="text-[10px] font-bold uppercase text-slate-400">Intake</p><p className="text-sm font-bold text-blue-600">{bal.intake} mL</p></div>
