    ...
    <div className="space-y-6 p-6">
      ...
      <Card className="p-5">
        <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
          ...
          <Link href="/audit/reports" className="text-xs font-bold text-indigo-700 hover:underline flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <Card className="p-5">
          <h3 className="font-bold text-slate-900 mb-4 flex items-center gap-2">
            <TrendingDown className="h-4 w-4 text-blue-600" /> Falls & Readmission Trend
          </h3>
          <ResponsiveContainer width="100%" height={180}>
            <LineChart data={TREND_DATA}>
              <CartesianGrid strokeDasharray="3 3" stroke="#f1f5f9" />
              ...
              <Card key={capa.id} className={cn("p-5 border-l-4",
                ...
                <div className="flex items-start justify-between mb-2">
                  <span className={cn("text-[10px] font-bold uppercase px-2 py-0.5 rounded border",
                    ...
                    capa.priority === 'medium' ? 'bg-amber-50 border-amber-200 text-amber-700' : 'bg-blue-50 border-blue-200 text-blue-700'
                  )}>{capa.priority}</span>
