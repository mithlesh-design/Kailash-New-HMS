...
const CONDITION_CONFIG = {
  ...
  Discharging: { color: 'bg-blue-100 border-blue-300 text-blue-800', icon: CheckCircle },
}
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-lg mx-auto p-6 space-y-5">
          ...
          <div className="p-5">
            ...
            {!cameraRequest && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 bg-blue-600 text-white rounded-xl font-semibold text-sm hover:bg-blue-700 active:scale-95 transition-all"
              >
            ...
            {cameraRequest?.status === 'declined' && (
              <div className="text-center py-4">
                ...
                <button
                  onClick={handleRequestCamera}
                  className="mt-3 text-xs text-blue-600 hover:text-blue-800 font-semibold transition-colors"
                >
                  Request again
                </button>
              </div>
        ...
        <div className="border-t border-slate-200 pt-4 text-center">
          <p className="text-xs text-slate-400">Powered by Kailash HMS · DISHA Compliant</p>
        </div>
      </div>
    </div>
  )
